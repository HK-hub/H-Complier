package com.hk.complier.lexer.handle;

import com.hk.complier.lexer.constant.InitialStatus;
import com.hk.complier.lexer.constant.WordMappingPool;
import com.hk.complier.lexer.constant.WordPool;
import com.hk.complier.lexer.exception.CommentMismatchException;
...
public class StringStreamResolver {
    ...
    // 检查多行注释是否存在错误
    protected static void preResolveCommentClear(String lines ,LexicalAnalyzer lexicalAnalyzer){
